  ...
  return (
    <section className="bg-blue-700 py-10 text-center text-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        {/* Named brokers go stale the moment someone leaves — this default
            names the role, not the person. */}
        <p className="text-blue-100 text-sm mb-6">{subtext || 'Speak with a licensed broker — free consultation, no pressure, no jargon.'}</p>
        <a
          href="tel:3057249840"
